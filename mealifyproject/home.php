    ...
    <div id="navbar">
        <div class="container">
            ...
            <ul>
                ...
                <li><a class="gallery" href="order.php" target="_blank">Menu</a></li>
    ...
    <div class="footer">
        <div class="container">
            ...
            <div class="subscribtion">
                ...
                <div class="quick-links">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#"><i class="fa-solid fa-angle-right"></i>Testimonial</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa-solid fa-angle-right"></i>Our Partners</a>
                        </li>
                        <li>
            ...
            <div class="contact-details">
                ...
                <ul>
                    <li>
                        <a href="#"><i class="fa-solid fa-location-dot"></i>A108 Adam Street, New
                            York, NY 535022</a>
                    </li>
                    <li>
